...
soma = sum(
    ...
    for i in range(6)         # Percorre as 6 primeiras linhas (parte superior da matriz)
    for j in range(i+1, 11 - i)  # Seleciona apenas os elementos da área superior da matriz
)
